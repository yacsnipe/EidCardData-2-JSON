...
namespace EidSamples
{
    class ReadData
    {
        ...
        /*public Dictionary<string, string> GetAllData()
        {
            ...
            byte[] photoFile = GetPhotoFile();
           
            content.Add("card_number", GetData("card_number"));
            content.Add("chip_number", GetData("chip_number"));
            content.Add("validity_begin_date", GetData("validity_begin_date"));
            content.Add("validity_end_date", GetData("validity_end_date"));
            content.Add("issuing_municipality", GetData("issuing_municipality"));
            content.Add("national_number", GetData("national_number"));
            content.Add("surname", GetData("surname"));
            content.Add("firstnames", GetData("firstnames"));
            content.Add("first_letter_of_third_given_name", GetData("first_letter_of_third_given_name"));
            content.Add("nationality", GetData("nationality"));
            content.Add("location_of_birth", GetData("location_of_birth"));
            content.Add("date_of_birth", GetData("date_of_birth"));
            content.Add("gender", GetData("gender"));
            content.Add("nobility", GetData("nobility"));
            content.Add("document_type", GetData("document_type"));
            content.Add("special_status", GetData("special_status"));
            content.Add("special_organization", GetData("special_organization"));
            content.Add("duplicata", GetData("duplicata"));
            content.Add("member_of_family", GetData("member_of_family"));
            try {
                content.Add("photo_hash", Convert.ToBase64String(photoFile));
                Console.WriteLine(Convert.ToBase64String(photoFile));
            }catch(Exception e) { }
          
            content.Add("date_and_country_of_protection", GetData("date_and_country_of_protection"));
            content.Add("address_street_and_number", GetData("address_street_and_number"));
            content.Add("address_zip", GetData("address_zip"));
            content.Add("address_municipality", GetData("address_municipality"));
...

        {
            ...
            content.Add("DATA_FILE", GetFile("DATA_FILE"));
            content.Add("ADDRESS_FILE", GetFile("ADDRESS_FILE"));
            content.Add("PHOTO_FILE", GetFile("PHOTO_FILE"));
            content.Add("SIGN_ADDRESS_FILE", GetFile("SIGN_ADDRESS_FILE"));
            content.Add("SIGN_DATA_FILE", GetFile("SIGN_DATA_FILE"));
            content.Add("CERT_RN_FILE", GetFile("CERT_RN_FILE"));
                ...
                if (slotlist.Length > 0)
                {
                    ...
                    if (session != null)
                    {
                        ...
                        while (counter > 0)
                        {
                            ...
                            if (data.Value.Value != null)
                            {
                                if (label == "[CharArrayAttribute Value=chip_number]")
                                {
                                    value = BitConverter.ToString(data.Value.Value).Replace("-", "");
                                    Console.WriteLine(BitConverter.ToString(data.Value.Value).Replace("-", ""));
        ...
        public string GetIdFileString()
        {
            ...
            return System.Text.Encoding.UTF8.GetString(GetFile("ADDRESS_FILE")).Length + "";
